Sebelumnya, pada materi **React JS** kita belajar bagaimana membuat web dinamis dengan library **React JS**. Kalian pasti sudah familiar dengan kode dan konsep dari library React.
